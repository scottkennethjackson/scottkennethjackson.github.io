...
const uncommon = [
    ['All-Purpose Tool, +1', 'magic-items/2400634-all-purpose-tool'],
    ...
    ['Amulet of the Devout, +1', 'magic-items/2411830-amulet-of-the-devout'],
    ['Arcane Grimoire, +1', 'magic-items/2411893-arcane-grimoire'],
    ['Bag of Holding', 'magic-items/4581-bag-of-holding'],
    ['Bloodwell Vial, +1', 'magic-items/2412091-bloodwell-vial'],
    ...
    ['Deck of Illusions', 'magic-items/4616-deck-of-illusions'],
    ...
    ['Feywild Shard', 'magic-items/2412248-feywild-shard'],
    ...
    ['Guardian Emblem', 'magic-items/2412282-guardian-emblem'],
    ...
    ['Moon Sickle, +1', 'magic-items/2405401-moon-sickle'],
    ...
    ['Rhythm Maker\'s Drum, +1', 'magic-items/2405713-rhythm-makers-drum'],
...
const rare = [
    ['Alchemical Compendium', 'magic-items/2400596-alchemical-compendium'],
    ['All-Purpose Tool, +2', 'magic-items/2400634-all-purpose-tool'],
    ['Amulet of Health', 'magic-items/4568-amulet-of-health'],
    ['Amulet of the Devout, +2', 'magic-items/2411830-amulet-of-the-devout'],
    ['Arcane Grimoire, +2', 'magic-items/2411893-arcane-grimoire'],
    ...
    ['Astral Shard', 'magic-items/2374941-astral-shard'],
    ['Astromancy Archive', 'magic-items/2400685-astromancy-archive'],
    ['Atlas of Endless Horizons', 'magic-items/2400706-atlas-of-endless-horizons'],
    ['Bag of Beans', 'magic-items/4579-bag-of-beans'],
    ['Bead of Force', 'magic-items/4583-bead-of-force'],
    ['Bell Branch', 'magic-items/2401130-bell-branch'],
    ...
    ['Bloodwell Vial, +2', 'magic-items/2412091-bloodwell-vial'],
    ...
    ['Devotee\'s Censer', 'magic-items/2407478-devotees-censer'],
    ['Dimensional Shackles', 'magic-items/4620-dimensional-shackles'],
    ['Dragon Slayer', 'magic-items/5385-dragon-slayer'],
    ['Dragonguard', 'magic-items/12467-dragonguard'],
    ['Duplicitous Manuscript', 'magic-items/2412157-duplicitous-manuscript'],
    ['Elemental Essence Shard, Air', 'magic-items/2407551-elemental-essence-shard'],
    ['Elemental Essence Shard, Earth', 'magic-items/2407551-elemental-essence-shard'],
    ['Elemental Essence Shard, Fire', 'magic-items/2407551-elemental-essence-shard'],
    ['Elemental Essence Shard, Water', 'magic-items/2407551-elemental-essence-shard'],
    ['Elven Chain', 'magic-items/4631-elven-chain'],
    ['Far Realm Shard', 'magic-items/2412226-far-realm-shard'],
    ...
    ['Fulminating Treatise', 'magic-items/2412256-fulminating-treatise'],
    ...
    ['Heart Weaver\'s Primer', 'magic-items/2412288-heart-weavers-primer'],
    ['Helm of Teleportation', 'magic-items/4656-helm-of-teleportation'],
    ['Heward\'s Handy Haversack', 'magic-items/5353-hewards-handy-haversack'],
    ...
    ['Ioun Stone of Awareness', 'magic-items/5415-ioun-stone'],
    ['Ioun Stone of Historical Knowledge', 'magic-items/5415-ioun-stone'],
    ['Ioun Stone of Language Knowledge', 'magic-items/5415-ioun-stone'],
    ['Ioun Stone of Natural Knowledge', 'magic-items/5415-ioun-stone'],
    ['Ioun Stone of Protection', 'magic-items/5415-ioun-stone'],
    ['Ioun Stone of Religious Knowledge', 'magic-items/5415-ioun-stone'],
    ['Ioun Stone of Reserve', 'magic-items/5415-ioun-stone'],
    ['Ioun Stone of Self Preservation', 'magic-items/5415-ioun-stone'],
    ['Ioun Stone of Sustenance', 'magic-items/5415-ioun-stone'],
    ['Ioun Stone of Supreme Intellect', 'magic-items/5415-ioun-stone'],
    ['Iron Bands of Bilarro', 'magic-items/5354-iron-bands-of-bilarro'],
    ['Libram of Souls and Flesh', 'magic-items/2412349-libram-of-souls-and-flesh'],
    ['Lyre of Building', 'magic-items/2405289-lyre-of-building'],
    ...
    ['Master\'s Amulet', 'magic-items/81901-masters-amulet'],
    ['Moon Sickle, +2', 'magic-items/2405401-moon-sickle'],
    ...
    ['Outer Essence Shard', 'magic-items/2405522-outer-essence-shard'],
    ['Periapt of Proof Against Poison', 'magic-items/4693-periapt-of-proof-against-poison'],
    ['Planecaller\'s Codex', 'magic-items/2405636-planecallers-codex'],
    ['Portable Hole', 'magic-items/4699-portable-hole'],
    ['Protective Verses', 'magic-items/2405662-protective-verses'],
    ['Reveler\'s Concertina', 'magic-items/2405691-revelers-concertina'],
    ['Rhythm Maker\'s Drum, +2', 'magic-items/2405713-rhythm-makers-drum'],
    ...
    ['Shadowfell Shard', 'magic-items/2408242-shadowfell-shard'],
    ['Shield, +2', 'magic-items/5157-shield-2'],
    ['Spider Staff', 'magic-items/9088-spider-staff'],
...
const veryRare = [
    ['All-Purpose Tool, +3', 'magic-items/2400634-all-purpose-tool'],
    ['Amulet of the Devout, +3', 'magic-items/2411830-amulet-of-the-devout'],
    ['Amulet of the Planes', 'magic-items/4570-amulet-of-the-planes'],
    ['Animated Shield', 'magic-items/4571-animated-shield'],
    ['Arcane Grimoire, +3', 'magic-items/2411893-arcane-grimoire'],
    ['Armor, +2', 'magic-items/5378-armor-2'],
    ['Arrow of Slaying', 'magic-items/4578-arrow-of-slaying'],
    ...
    ['Bloodwell Vial, +3', 'magic-items/2412091-bloodwell-vial'],
    ['Candle of Invocation', 'magic-items/4598-candle-of-invocation'],
    ['Carpet of Flying', 'magic-items/5373-carpet-of-flying'],
    ['Cauldron of Rebirth', 'magic-items/2401168-cauldron-of-rebirth'],
    ['Cloak of Arachnida', 'magic-items/4604-cloak-of-arachnida'],
    ['Crystal Ball', 'magic-items/4610-crystal-ball'],
    ['Crystalline Chronicle', 'magic-items/2407470-crystalline-chronicle'],
    ['Dancing Sword', 'magic-items/5383-dancing-sword'],
    ['Dragon Scale Mail, Black', 'magic-items/5380-dragon-scale-mail'],
    ['Dragon Scale Mail, Blue', 'magic-items/5380-dragon-scale-mail'],
    ['Dragon Scale Mail, Brass', 'magic-items/5380-dragon-scale-mail'],
    ['Dragon Scale Mail, Bronze', 'magic-items/5380-dragon-scale-mail'],
    ['Dragon Scale Mail, Copper', 'magic-items/5380-dragon-scale-mail'],
    ['Dragon Scale Mail, Gold', 'magic-items/5380-dragon-scale-mail'],
    ['Dragon Scale Mail, Green', 'magic-items/5380-dragon-scale-mail'],
    ['Dragon Scale Mail, Red', 'magic-items/5380-dragon-scale-mail'],
    ['Dragon Scale Mail, Silver', 'magic-items/5380-dragon-scale-mail'],
    ['Dragon Scale Mail, White', 'magic-items/5380-dragon-scale-mail'],
    ['Dwarven Plate', 'magic-items/4626-dwarven-plate'],
    ['Dwarven Thrower', 'magic-items/4627-dwarven-thrower'],
    ['Efreeti Bottle', 'magic-items/4629-efreeti-bottle'],
    ['Figurine of Wondrous Power, Obsidian Steed', 'magic-items/5413-figurine-of-wondrous-power'],
    ['Frost Brand', 'magic-items/5387-frost-brand'],
    ['Helm of Brilliance', 'magic-items/4653-helm-of-brilliance'],
    ['Horn of Valhalla, Bronze', 'magic-items/5414-horn-of-valhalla'],
    ['Horn of Valhalla, Bronze', 'magic-items/5414-horn-of-valhalla'],
    ['Horseshoes of a Zephyr', 'magic-items/4660-horseshoes-of-a-zephyr'],
    ['Instrument of the Bards, Anstruth Harp', 'magic-items/5508-instrument-of-the-bards'],
    ['Ioun Stone of Absorption', 'magic-items/5415-ioun-stone'],
    ['Ioun Stone of Agilty', 'magic-items/5415-ioun-stone'],
    ['Ioun Stone of Fortitude', 'magic-items/5415-ioun-stone'],
    ['Ioun Stone of Insight', 'magic-items/5415-ioun-stone'],
    ['Ioun Stone of Intellect', 'magic-items/5415-ioun-stone'],
    ['Ioun Stone of Leadership', 'magic-items/5415-ioun-stone'],
    ['Ioun Stone of Strength', 'magic-items/5415-ioun-stone'],
    ['Manual of Bodily Health', 'magic-items/4674-manual-of-bodily-health'],
    ['Manual of Clay Golems', 'magic-items/5416-manual-of-golems'],
    ['Manual of Flesh Golems', 'magic-items/5416-manual-of-golems'],
    ['Manual of Gainful Exercise', 'magic-items/4675-manual-of-gainful-exercise'],
    ['Manual of Iron Golems', 'magic-items/5416-manual-of-golems'],
    ['Manual of Quickness of Action', 'magic-items/4677-manual-of-quickness-of-action'],
    ['Manual of Stone Golems', 'magic-items/5416-manual-of-golems'],
    ['Moon Sickle, +3', 'magic-items/2405401-moon-sickle'],
    ['Mirror of Life Trapping', 'magic-items/4680-mirror-of-life-trapping'],
    ['Nine Lives Stealer', 'magic-items/5394-nine-lives-stealer'],
    ['Nolzur\'s Marvelous Pigments', 'magic-items/4678-marvelous-pigments'],
    ['Oathbow', 'magic-items/4686-oathbow'],
    ['Rhythm Maker\'s Drum, +3', 'magic-items/2405713-rhythm-makers-drum'],
    ['Ring of Regeneration', 'magic-items/4727-ring-of-regeneration'],
    ['Ring of Shooting Stars', 'magic-items/4729-ring-of-shooting-stars'],
    ['Ring of Telekinesis', 'magic-items/4733-ring-of-telekinesis'],
    ['Robe of Scintillating Colors', 'magic-items/4740-robe-of-scintillating-colors'],
    ['Robe of Stars', 'magic-items/4741-robe-of-stars'],
    ['Rod of Absorption', 'magic-items/4744-rod-of-absorption'],
    ['Rod of Alertness', 'magic-items/4745-rod-of-alertness'],
    ['Rod of Security', 'magic-items/4748-rod-of-security'],
    ['Rod of the Pact Keeper, +1', 'magic-items/11214-rod-of-the-pact-keeper'],
    ...
    ['Staff of Fire', 'magic-items/4761-staff-of-fire'],
    ['Staff of Frost', 'magic-items/4762-staff-of-frost'],
    ['Staff of Power', 'magic-items/4764-staff-of-power'],
    ['Staff of Striking', 'magic-items/4765-staff-of-striking'],
    ['Staff of Thunder and Lightning', 'magic-items/4770-staff-of-thunder-and-lightning'],
    ['Sword of Sharpness', 'magic-items/5391-sword-of-sharpness'],
    ...
    ['Wand of Polymorph', 'magic-items/4796-wand-of-polymorph'],
    ['Wand of the War Mage, +3', 'magic-items/34712-wand-of-the-war-mage'],
    ['Weapon, +3', 'magic-items/5404-weapon-3']
];

const legendary = [
    ['Apparatus of Kwalish', 'magic-items/5344-apparatus-of-kwalish'],
    ['Armor, +3', 'magic-items/5379-armor-3'],
    ['Armor of Invulnerability', 'magic-items/4574-armor-of-invulnerability'],
    ...
    ['Blackrazor', 'magic-items/5429-blackrazor'],
    ['Cloak of Invisibility', 'magic-items/5347-cloak-of-invisibility'],
    ...
    ['Cubic Gate', 'magic-items/4612-cubic-gate'],
    ['Deck of Many Things', 'magic-items/4617-deck-of-many-things'],
    ['Defender', 'magic-items/5384-defender'],
    ['Efreeti Chain', 'magic-items/5350-efreeti-chain'],
    ['Hammer of Thunderbolts', 'magic-items/4649-hammer-of-thunderbolts'],
    ['Holy Avenger', 'magic-items/5389-holy-avenger'],
    ...
    ['Ioun Stone of Greater Absorption', 'magic-items/5415-ioun-stone'],
    ['Ioun Stone of Mastery', 'magic-items/5415-ioun-stone'],
    ['Ioun Stone of Regeneration', 'magic-items/5415-ioun-stone'],
    ['Iron Flask', 'magic-items/4666-iron-flask'],
    ['Luck Blade', 'magic-items/5393-luck-blade'],
    ['Plate Armor of Etherealness', 'magic-items/4698-plate-armor-of-etherealness'],
    ['Ring of Djinni Summoning', 'magic-items/4718-ring-of-djinni-summoning'],
    ['Ring of Elemental Command, Air', 'magic-items/5509-ring-of-elemental-command'],
    ['Ring of Elemental Command, Earth', 'magic-items/5509-ring-of-elemental-command'],
    ['Ring of Elemental Command, Fire', 'magic-items/5509-ring-of-elemental-command'],
    ['Ring of Elemental Command, Water', 'magic-items/5509-ring-of-elemental-command'],
    ['Ring of Invisibility', 'magic-items/4723-ring-of-invisibility'],
    ['Ring of Spell Turning', 'magic-items/4731-ring-of-spell-turning'],
    ['Ring of Three Wishes', 'magic-items/4735-ring-of-three-wishes'],
    ['Robe of the Archmagi', 'magic-items/4742-robe-of-the-archmagi'],
    ['Rod of Lordly Might', 'magic-items/4746-rod-of-lordly-might'],
    ['Rod of Resurrection', 'magic-items/5395-rod-of-resurrection'],
    ['Scarab of Protection', 'magic-items/4751-scarab-of-protection'],
    ['Sphere of Annihilation', 'magic-items/4759-sphere-of-annihilation'],
    ['Staff of the Magi', 'magic-items/4767-staff-of-the-magi'],
    ['Sword of Answering', 'magic-items/5506-sword-of-answering'],
    ['Talisman of Pure Good', 'magic-items/4778-talisman-of-pure-good'],
    ['Talisman of the Sphere', 'magic-items/4779-talisman-of-the-sphere'],
    ['Talisman of Ultimate Evil', 'magic-items/4780-talisman-of-ultimate-evil'],
    ['Tome of the Stilled Tongue', 'magic-items/5409-tome-of-the-stilled-tongue'],
    ['Vorpal Sword', 'magic-items/5397-vorpal-sword'],
    ['Wave', 'magic-items/5431-wave'],
    ['Well of Many Worlds', 'magic-items/4802-well-of-many-worlds'],
    ['Whelm', 'magic-items/5432-whelm']
];